...
export const TrialBanner: React.FC = () => {
  ...
  // Determine banner style based on urgency - Dark Theme Compatible
  ...
  return (
    <div className={`relative border-2 ${style.bgColor} p-4 z-[70] rounded-lg shadow-md backdrop-blur-sm`}>
