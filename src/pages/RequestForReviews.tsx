        ...
        <div className="bg-red-950/30 border-2 border-red-500/50 rounded-2xl p-8 max-w-2xl w-full backdrop-blur-sm">
          ...
          <p className="text-red-300/90 mb-6 text-lg">
            {subscriptionStatus === 'none'
              ? 'You need an active subscription to access this feature. Start your 15-day free trial or upgrade now to request reviews from your customers.'
              : 'Your 15-day trial has expired. Upgrade now to request reviews from your customers and manage review campaigns.'}
          </p>
