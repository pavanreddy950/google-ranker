        ...
        <div className="bg-red-950/30 border-2 border-red-500/50 rounded-2xl p-8 max-w-2xl w-full backdrop-blur-sm">
          ...
          <p className="text-red-300/90 mb-6 text-lg">
            {subscriptionStatus === 'none'
              ? 'You need an active subscription to access this feature. Start your 15-day free trial or upgrade now to access the Audit Tool.'
              : 'Your 15-day trial has expired. Upgrade now to access the Audit Tool and analyze your Google Business Profile performance.'}
          </p>
      ...
      <Card className="border-2 border-primary/40 shadow-lg">
        ...
        <CardContent className="space-y-4 pt-6">
          <div className="w-full">
            ...
            >
              <SelectTrigger className="w-full h-14 text-base font-medium border-2 border-primary/40 bg-card hover:border-primary focus:ring-4 focus:ring-primary/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Active Profile Info */}
            {selectedLocation && (
              <div className="p-4 bg-green-950/20 border-2 border-green-500/30 rounded-lg">
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                  <div className="flex-1">
                    <h4 className="font-medium text-green-400">Selected Profile</h4>
                    <p className="text-sm text-green-300">{selectedLocation.name}</p>
                    <p className="text-xs text-green-400/80">{selectedLocation.accountName}</p>
                  </div>
                  <Badge className="bg-green-500/20 text-green-300 border border-green-500/40">Active</Badge>
                </div>
              </div>
            )}
            ...
            {/* Upgrade Prompt */}
            {lockedLocations.length > 0 && (
              <div className="p-4 bg-orange-950/20 border-2 border-orange-500/30 rounded-lg">
                <div className="flex items-center gap-3">
          ...
          <TabsContent value="overview" className="space-y-6">
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-foreground text-lg mb-1">Google Search Rank</h3>
                      <p className="text-sm text-muted-foreground">Avg. position of your business on Google Search</p>
                    </div>
                  </div>
                ...
                <div className="mt-6 flex items-center justify-between text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-muted-foreground">Less than 5</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 bg-yellow-500 rounded-full"></div>
                    <span className="text-foreground">Average</span>
                    <span className="text-muted-foreground">Between 6-10</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 bg-red-500 rounded-full"></div>
                    <span className="text-foreground">Poor</span>
                    <span className="text-muted-foreground">Beyond 10</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <CardContent className="p-6">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-end gap-3">
                      <div className="text-5xl font-bold text-foreground">{auditScore.profileCompletion}%</div>
              ...
              <Card className="border-2 border-border/60">
                <CardContent className="p-6">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-end gap-3">
                      <div className="text-5xl font-bold text-foreground">{auditScore.seoScore}%</div>
                      <span className={`text-lg font-semibold mb-2 ${
              ...
              <Card className="border-2 border-border/60">
                <CardContent className="p-6">
                  <div className="space-y-4">
                    <h3 className="font-semibold text-foreground">Review Score</h3>
                    <div className="flex items-end gap-3">
                    ...
                    <p className="text-sm text-muted-foreground">Ideal - 2 per week</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 border-border/60">
                <CardContent className="p-6">
                  <div className="space-y-4">
                    <h3 className="font-semibold text-foreground">Review Reply Score</h3>
                    <div className="flex items-end gap-3">
                      <div className="text-5xl font-bold text-foreground">{auditScore.reviewReplyScore}%</div>
                      <span className={`text-lg font-semibold mb-2 ${
