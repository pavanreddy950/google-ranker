...
class DailyActivityEmailService {
  constructor() {
    ...
    this.fromName = 'Google Ranker Daily Report';
  ...
  <div class="container">
    ...
    <div class="footer">
      ...
      <p style="margin: 10px 0; font-size: 12px; color: #9CA3AF;">
        You're receiving this daily report because you have an active Google Ranker account.<br>
    ...
    const text = `
Google Ranker Daily Activity Report - ${today}
...
© ${new Date().getFullYear()} Google Ranker. All rights reserved.
  ...
  generateWelcomeEmail(userName, userEmail) {
    const subject = '🎉 Welcome to Google Ranker - Let\'s Get Started!';
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p class="intro-text">
        Welcome to Google Ranker! We're excited to help you automate and optimize your Google Business Profile management.
      ...
      <h3 style="color: #111827; font-size: 18px; margin: 30px 0 20px 0; text-align: center;">
        What You Can Do With Google Ranker
      </h3>
    ...
    <div class="footer">
      ...
      <p style="margin: 10px 0; font-size: 12px; color: #9CA3AF;">
        You're receiving this email because you just signed up for Google Ranker.
      </p>
    </div>
  </div>
</body>
