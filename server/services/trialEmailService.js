...
class TrialEmailService {
  constructor() {
    ...
    this.fromEmail = 'support@googleranker.com';
    this.fromName = 'Google Ranker Support';
    this.websiteUrl = 'https://www.googleranker.com';
    this.appUrl = 'https://app.googleranker.com';
  ...
  generateEmailTemplate(userName, daysRemaining, trialEndDate, emailType) {
    ...
    if (emailType === 'expired') {
      subject = '⏰ Your Google Ranker Trial Has Expired - Upgrade Now!';
      ...
      subject = '⚠️ Last Day of Your Google Ranker Trial!';
      ...
      subject = `⏰ Only ${daysRemaining} Days Left on Your Google Ranker Trial`;
      ...
      subject = `🚀 ${daysRemaining} Days Left in Your Google Ranker Trial`;
...
<body>
  <div class="container">
    <!-- Header -->
    <div class="header">
      <h1 class="logo">Google Ranker</h1>
    ...
    <div class="footer">
      ...
      <p style="margin: 20px 0; font-size: 13px;">
        © ${new Date().getFullYear()} Google Ranker. All rights reserved.
      </p>

      <p style="margin: 10px 0; font-size: 12px; color: #9CA3AF;">
        You're receiving this email because you have an active trial with Google Ranker.<br>
  ...
  async sendTestEmail(userEmail) {
    try {
      ...
      const msg = {
        ...
        subject: '✅ Google Ranker Email System Test',
        text: 'This is a test email from Google Ranker trial reminder system. If you received this, the email system is working correctly!',
        html: `
<!DOCTYPE html>
<html>
<head>
