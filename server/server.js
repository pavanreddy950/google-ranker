...
const HARDCODED_ACCOUNT_ID = process.env.HARDCODED_ACCOUNT_ID || '';
  ...
  try {
    ...
    try {
      ...
      if (tokenError.message === 'invalid_client') {
        ...
        console.error('  2. Find your OAuth 2.0 Client ID:', process.env.GOOGLE_CLIENT_ID);
        console.error('  3. Verify Client Secret matches what\'s in environment variables');
