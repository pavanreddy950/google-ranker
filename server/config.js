...
class Config {
  ...
  setProductionDefaults() {
    ...
    const productionDefaults = {
      ...
      GOOGLE_REDIRECT_URI: process.env.GOOGLE_REDIRECT_URI || 'https://your-frontend-url.com/auth/google/callback',
      GOOGLE_CLIENT_ID: process.env.GOOGLE_CLIENT_ID || 'your-google-client-id.apps.googleusercontent.com',
      GOOGLE_CLIENT_SECRET: process.env.GOOGLE_CLIENT_SECRET || 'GOCSPX-your-google-client-secret',
      HARDCODED_ACCOUNT_ID: process.env.HARDCODED_ACCOUNT_ID || 'your-google-business-account-id',
      ...
      AZURE_OPENAI_ENDPOINT: process.env.AZURE_OPENAI_ENDPOINT || 'https://your-openai-resource.openai.azure.com/',
  ...
  get frontendUrl() {
    // Use configured frontend URL or fallback to localhost in development
    if (process.env.NODE_ENV === 'production') {
      return process.env.FRONTEND_URL || 'https://your-frontend-url.com';
    }
  ...
  get allowedOrigins() {
    ...
    if (this.isAzure || process.env.NODE_ENV === 'production') {
      // Production origins from environment variables
      if (process.env.PRODUCTION_FRONTEND_URL) {
        origins.push(process.env.PRODUCTION_FRONTEND_URL);
      }
      if (process.env.PRODUCTION_BACKEND_URL) {
        origins.push(process.env.PRODUCTION_BACKEND_URL);
      }

      // Add dynamic hostname if available (Azure/cloud platform)
